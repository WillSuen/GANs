...
# This class is forked from https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix
...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--Z', type=int, default=100, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=256, help='then crop to this size')
        self.parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels')
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
        self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
        self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--wclip', type=float, default=0.01, help='weight clip for Wassertein GAN')
        ...
        self.parser.add_argument('--model', type=str, default='dcgan',
                                 help='chooses which model to use. dcgan, wgan, infogan, cyclegan, ...')
        ...
        self.parser.add_argument('--no_lsgan', action='store_true', help='do *not*s use least quare GAN, if false, use vanilla GAN')
